...
if __name__ == "__main__":
    ...
    #    break
    #auto_buy.one_buy( [ { "horce_num": 3, "money": 2 }, { "horce_num": 6, "money": 1 } ], None )
    #race_id = "202204030401"
    #key="https://race.netkeiba.com/race/shutuba.html?race_id=" + race_id
    #r, _ = lib.request( key )
    #soup = BeautifulSoup( r.content, "html.parser" )
    #print( base_race_collect.outside_get( soup ) )
    ...
    url = "https://race.netkeiba.com/top/?_q=top"
    r, _ = lib.request( url )
    soup = BeautifulSoup( r.content, "html.parser" )
