...
def horce_jockey_true_skill_index( horce_id, storage: Storage, data, common_past_data: CommonPastData ):
    my_true_skill = None
    true_skill_list = []
    ...
    for diff_horce_id in storage.horce_id_list:
        try:
            ...
            true_skill = common_past_data.true_skill_data["horce"][diff_horce_id] + common_past_data.true_skill_data["jockey"][jockey_id]
    ...
    if my_true_skill == None:
        ...
        data[horce_id][name.horce_jockey_true_skill_index+".users"] = int( true_skill_list.index( my_true_skill ) )
        data[horce_id][name.horce_jockey_true_skill_index+".rank"] = true_skill_list.index( my_true_skill )
