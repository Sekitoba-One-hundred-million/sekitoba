...
def mother_rank( horce_id, storage: Storage, data ):
    ...
    mother_rank = lib.match_rank_score( mother_pd, None, place = place_num, baba_status = baba_status, dist_kind = dist_kind )
    data[horce_id][name.mother_rank+".users"] = mother_rank
    data[horce_id][name.mother_rank+".rank"] = mother_rank
