...
class UsersData:
    ...
    def before_users_data_analyze( self, storage: Storage, past_race_data ):
        for horce_id in storage.horce_id_list:
            ...
            data_create.straight_slope( horce_id, storage, self.data, past_race_data )
            data_create.foot_used( horce_id, storage, self.data, past_race_data )
            ...
            data_create.trainer_rank( horce_id, storage, self.data )
            data_create.jockey_rank( horce_id, storage, self.data )
            ...
            data_create.jockey_year_rank( horce_id, storage, self.data )
            ...
            data_create.before_pace( horce_id, storage, self.data, past_race_data )
