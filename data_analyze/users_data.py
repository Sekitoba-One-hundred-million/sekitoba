...
class UsersData:
    ...
    def before_users_data_analyze( self, storage: Storage ):
        ...
        for horce_id in storage.horce_id_list:
            ...
            data_create.trainer_true_skill( horce_id, storage, self.data, common_past_data )
            data_create.trainer_true_skill_index( horce_id, storage, self.data, common_past_data )
